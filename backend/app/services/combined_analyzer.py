...
When both image and symptoms are provided, cross-reference them for a more accurate assessment.
...
You must ALWAYS respond with valid JSON in exactly this format and nothing else:
{
    ...
    "recommended_tests": ["recommended test 1", "recommended test 2"],
    "suggested_treatment": ["treatment suggestion 1", "treatment suggestion 2"],
...
- When both X-ray and symptoms are provided cross-reference them
